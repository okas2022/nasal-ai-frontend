document.getElementById("analyzeBtn").addEventListener("click", async () => {
  ...
  try {
    ...
    window.riskChart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [
          ...
          { label: "정상기준(%)", data: Object.values(data.normal_ranges).map(v => v * 100), backgroundColor: "rgba(102, 204, 255, 0.3)" }
        ]
      },
      options: {
        responsive: true,
    ...
    console.error(err);
    resultText.textContent = "서버 오류: " + err.message;
  }
});
